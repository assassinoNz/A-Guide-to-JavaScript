...
let jsonStringManual = '{"team": "Avengers","setting": "Marvel Cinematic Universe","members": [{"name": "Captain America","alive": true,"yearOfBirth": 1918,"secretIdentity": "Steven Grant \\"Steve\\" Rogers","affiliations": ["United States Army","S.H.I.E.L.D."]},{"name": "Iron Man","alive": false,"yearOfBirth": 1970,"secretIdentity": "Anthony Edward \\"Tony\\" Stark","affiliations": ["MIT","Stark Industries"]},{"name": "Thor Odinson","alive": true,"yearOfBirth": 964,"secretIdentity": null,"affiliations": ["Asgardian Royal Family","Revengers"]}]}';
...
let jsonStringAPI = JSON.stringify(javaScriptObject);
console.log(jsonString);
...
let parsedJsonStringAPI = JSON.parse(jsonStringAPI);
console.log(parsedJsonStringAPI);